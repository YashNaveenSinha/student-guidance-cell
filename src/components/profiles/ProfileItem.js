            ...
            <div className="profile-1">
                ...
                <div className="mx-auto profile-buttons">
                    {authUser.isUserAuthenticated ? (
                        ...
                        <Fragment>
                            <button type="button" data-toggle="tooltip" data-placement="right" title="Please Login as a User to book appointment" className="rounded-pill profile-btn btn btn-info disabled">
