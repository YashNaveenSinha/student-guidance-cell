    ...
    const authUserLinks = (
        <Fragment>
            <Link className="nav-logo" to="/appointment">
                Student Guidance Cell<img className="nav-log-img" style={{ width: "2.2rem" }} src={require("./nitcLogo.png")} />
            </Link>
    ...
    const authDoctorLinks = (
        <Fragment>
            <Link className="nav-logo" to="/dashboard">
                Student Guidaance Cell<img className="nav-log-img" style={{ width: "2.2rem" }} src={require("./nitcLogo.png")} />
            </Link>
            <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false"
                aria-label="Toggle navigation">
                <span className="navbar-toggler-icon"></span>
